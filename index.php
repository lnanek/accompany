    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Accompany</a>
            </div>
...
<!-- end of event 1 -->
<!-- start of event Learn about Investing -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event 2 -->
<!-- start of event Workout session -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Workout session -->
<!-- start of event Damn Good Place for Podcasters Meetup-->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Lunch at Damn Good Place for Podcasters Meetup -->
<!-- start of event How to save for retirement -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Product Team Cruise!! -->
<!-- start of event Infographics workshop -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Infographics workshop-->
<!-- start of event Brown Bag Lunch - AWS best practices -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Brown Bag Lunch - AWS best practices -->
<!-- start of event Play with an Oculus! -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Play with an Oculus!-->
...
<!-- end of event SBS Happy hour -->
<!-- start of event SBS Bagel Breakfast -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event SBS Bagel Breakfast -->
<!-- start of event Artificial Intelligence Meetup -->
                <div class="col-sm-4 portfolio-item">
...
<!-- end of event Artificial Intelligence Meetup -->
<!-- start of event Networking Lunch -->
                <div class="col-sm-4 portfolio-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-6">
                        <h3>Location</h3>
                        <p>640 Byrant St<br>San Francisco, CA 94107</p>
                    </div>
                    <div class="footer-col col-md-6">
